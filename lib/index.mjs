...
import hypenate from 'lodash/kebabCase';
import deepClone from 'lodash/clone';
import deepAssign from 'lodash/merge';
import isVoid from 'lodash/isNil';
...
import { CustEvent, Log, isString, isObject, isNumeric, getDeepProperty, isEmpty, isPromise, isHTMLString, isPosterityNode, $, setStyle, getStyle, setAttr, addEvent, getAttr, removeEvent, addClassName, isEvent, runRejectableQueue, runStoppableQueue, transObjectAttrIntoArray } from 'chimee-helper';
