...
import { isString, isFunction, isNumber, deepAssign, isObject, isNumeric, bind, getDeepProperty, isArray, Log, isEmpty, isError, isBoolean, isInteger, isPromise, isElement, isHTMLString, hypenate, isPosterityNode, $, setStyle, getStyle, setAttr, addEvent, getAttr, removeEvent, addClassName, isEvent, runRejectableQueue, runStoppableQueue, camelize, isVoid, deepClone, transObjectAttrIntoArray } from 'chimee-helper';
...
}, _temp), _descriptor$2 = _applyDecoratedDescriptor$7(_class2$1.prototype, '__id', [frozen], {
  enumerable: true,
  initializer: function initializer() {
    return '_vm';
  }
