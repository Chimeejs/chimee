...
import { $, Log, addClassName, addEvent, bind, camelize, deepAssign, deepClone, getAttr, getDeepProperty, getStyle, hypenate, isArray, isBoolean, isElement, isEmpty, isError, isFunction, isHTMLString, isInteger, isNumber, isObject, isPosterityNode, isPromise, isString, isVoid, removeEvent, runRejectableQueue, runStoppableQueue, setAttr, setStyle, transObjectAttrIntoArray } from 'chimee-helper';
import Kernel from 'chimee-kernel';
import _Map from 'babel-runtime/core-js/map';
import _Object$keys from 'babel-runtime/core-js/object/keys';
import { accessor, alias, alwaysBoolean, alwaysNumber, alwaysString, applyDecorators, autobind, autobindClass, before, configurable, frozen, initArray, initString, lock, nonenumerable, nonextendable, waituntil, watch } from 'toxic-decorators';
  ...
  _createClass(VideoWrapper, [{
    ...
    value: function $watch(key, handler) {
      ...
      var watcher = function watcher() {
        if (watching) bind(handler, this).apply(undefined, arguments);
      };
      ...
      var target = keys.length === 0 && !other && videoConfig._realDomAttr.indexOf(property) > -1 ? videoConfig : getDeepProperty(other || this, keys, { throwError: true });
...
var accessorMap = {
  ...
  width: [accessor({ set: numberOrVoid }), accessorVideoAttribute('width')],
  height: [accessor({ set: numberOrVoid }), accessorVideoAttribute('height')],
...
var VideoConfig = (_dec$4 = initString(), _dec2$4 = initString(function (str) {
  return str.toLocaleLowerCase();
}), _dec3$4 = initArray(), (_class$4 = function () {
...
}), _descriptor3$1 = _applyDecoratedDescriptor$4(_class$4.prototype, 'type', [_dec$4, configurable], {
  enumerable: true,
  initializer: function initializer() {
    return 'vod';
  }
}), _descriptor4 = _applyDecoratedDescriptor$4(_class$4.prototype, 'box', [_dec2$4, configurable], {
  enumerable: true,
  initializer: function initializer() {
    return '';
  }
}), _descriptor5 = _applyDecoratedDescriptor$4(_class$4.prototype, 'runtimeOrder', [_dec3$4, configurable], {
  enumerable: true,
  initializer: function initializer() {
    return ['html5', 'flash'];
  }
}), _descriptor6 = _applyDecoratedDescriptor$4(_class$4.prototype, '_kernelProperty', [frozen], {
  enumerable: true,
  initializer: function initializer() {
    return ['type', 'box', 'runtimeOrder'];
  }
}), _descriptor7 = _applyDecoratedDescriptor$4(_class$4.prototype, '_realDomAttr', [frozen], {
  enumerable: true,
  initializer: function initializer() {
