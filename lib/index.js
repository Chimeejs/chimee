...
var hypenate = _interopDefault(require('lodash/kebabCase'));
var deepClone = _interopDefault(require('lodash/clone'));
var deepAssign = _interopDefault(require('lodash/merge'));
var isVoid = _interopDefault(require('lodash/isNil'));
var camelize = _interopDefault(require('lodash/camelCase'));
...
var bind = _interopDefault(require('lodash/bind'));
...
function accessorWidthAndHeight(property) {
  return toxicDecorators.accessor({
    get: function get(value) {
      ...
      if (chimeeHelper.isNumeric(attr) && isNumber(prop)) return prop;
...
var VideoConfig = (_dec = toxicDecorators.initBoolean(), _dec2 = toxicDecorators.initString(function (str) {
  ...
  return VideoConfig;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'needToLoadSrc', [toxicDecorators.nonenumerable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'changeWatchable', [toxicDecorators.nonenumerable], {
  enumerable: true,
  initializer: function initializer() {
    return true;
  }
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'inited', [toxicDecorators.nonenumerable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, 'isLive', [_dec, toxicDecorators.configurable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'box', [_dec2, toxicDecorators.configurable], {
  enumerable: true,
  initializer: function initializer() {
    return '';
  }
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, '_kernelProperty', [toxicDecorators.frozen], {
  enumerable: true,
  initializer: function initializer() {
    return ['isLive', 'box', 'preset', 'kernels', 'presetConfig'];
  }
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, '_realDomAttr', [toxicDecorators.frozen], {
  enumerable: true,
  initializer: function initializer() {
...
var VideoWrapper = (_dec$1 = toxicDecorators.autobindClass(), _dec2$1 = toxicDecorators.alias('silentLoad'), _dec3 = toxicDecorators.alias('fullScreen'), _dec4 = toxicDecorators.alias('$fullScreen'), _dec5 = toxicDecorators.alias('fullscreen'), _dec6 = toxicDecorators.alias('emit'), _dec7 = toxicDecorators.alias('emitSync'), _dec8 = toxicDecorators.alias('on'), _dec9 = toxicDecorators.alias('addEventListener'), _dec10 = toxicDecorators.before(eventBinderCheck), _dec11 = toxicDecorators.alias('off'), _dec12 = toxicDecorators.alias('removeEventListener'), _dec13 = toxicDecorators.before(eventBinderCheck), _dec14 = toxicDecorators.alias('once'), _dec15 = toxicDecorators.before(eventBinderCheck), _dec16 = toxicDecorators.alias('css'), _dec17 = toxicDecorators.before(attrAndStyleCheck), _dec18 = toxicDecorators.alias('attr'), _dec19 = toxicDecorators.before(attrAndStyleCheck), _dec$1(_class$1 = (_class2 = function () {
  ...
  _createClass(VideoWrapper, [{
    ...
    value: function $watch(key, handler) {
      ...
      if (!chimeeHelper.isString(key) && !isArray(key)) throw new TypeError('$watch only accept string and Array<string> as key to find the target to spy on, but not ' + key + ', whose type is ' + (typeof key === 'undefined' ? 'undefined' : _typeof(key)));
      var watching = true;
    ...
    value: function $set(obj, property, value) {
      if (!chimeeHelper.isObject(obj) && !isArray(obj)) throw new TypeError('$set only support Array or Object, but not ' + obj + ', whose type is ' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)));
    ...
    value: function $del(obj, property) {
      if (!chimeeHelper.isObject(obj) && !isArray(obj)) throw new TypeError('$del only support Array or Object, but not ' + obj + ', whose type is ' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)));
      // $FlowFixMe: we have custom this function
    ...
    value: function $emit(key) {
      ...
      var target = void 0;
      if (chimeeHelper.isObject(key) && chimeeHelper.isString(key.name) && chimeeHelper.isString(key.target)) {
        target = key.target;
        key = key.name;
      }
  ...
  function Plugin() {
    ...
    if (!chimeeHelper.isEmpty(computed) && chimeeHelper.isObject(computed)) {
      var props = _Object$keys(computed).reduce(function (props, key) {
        ...
        if (chimeeHelper.isObject(val) && (isFunction(val.get) || isFunction(val.set))) {
 ...
 * </pre>
 */
var Dom = (_dec$3 = toxicDecorators.waituntil('__dispatcher.videoConfigReady'), _dec2$2 = toxicDecorators.before(attrOperationCheck, targetCheck), _dec3$1 = toxicDecorators.before(attrOperationCheck, targetCheck), _dec4$1 = toxicDecorators.before(attrOperationCheck, targetCheck), _dec5$1 = toxicDecorators.before(attrOperationCheck, targetCheck), _dec6$1 = toxicDecorators.before(targetCheck), (_class$3 = function () {
  _createClass(Dom, [{
    key: 'mouseInVideo',
  ...
  function Dom(config, dispatcher) {
    ...
    if (!isElement(wrapper) && !chimeeHelper.isString(wrapper)) throw new TypeError('Wrapper can only be string or HTMLElement, but not ' + (typeof wrapper === 'undefined' ? 'undefined' : _typeof(wrapper)));
  ...
  _createClass(Dom, [{
    ...
    value: function setPluginsZIndex(plugins) {
      ...
      plugins.forEach(function (key, index) {
        return chimeeHelper.setStyle(key.match(/^(videoElement|container)$/) ? _this[key] : _this.plugins[key], 'z-index', ++index);
      });
    }
 ...
 * </pre>
 */
var Bus = (_dec$4 = toxicDecorators.runnable(secondaryChecker), _dec2$3 = toxicDecorators.runnable(secondaryChecker, {
  backup: function backup() {
    return false;
  }
}), _dec3$2 = toxicDecorators.runnable(secondaryChecker), _dec4$2 = toxicDecorators.runnable(secondaryChecker, {
  backup: function backup() {
    return false;
  }
}), (_class$4 = function () {
  ...
  _createClass(Bus, [{
    ...
    value: function _removeEvent(keys, fn) {
      ...
      if (queue.length < 1) {
        ...
        for (var _i = backtrackList.length - 1; _i > -1; _i--) {
          ...
          if (!chimeeHelper.isEmpty(parent[key])) break;
          delete parent[key];
        }
      }
      return hasFn;
    ...
    value: function _getEventQueue(handlerSet, order) {
      ...
      return chimeeHelper.isEmpty(handlerSet) ? [] : order.reduce(function (queue, id) {
        if (chimeeHelper.isEmpty(handlerSet[id]) || !isArray(handlerSet[id]) ||
...
function isEventEmitalbe(_ref2) {
  ...
  if (!name || !chimeeHelper.isString(name) || secondaryReg$1.test(name)) {
    chimeeHelper.Log.error('You must provide a legal event name, which is string and could not started with before/after/_');
    return false;
  }
  if (!id || !chimeeHelper.isString(id)) {
    chimeeHelper.Log.error('You must provide the id of emitter');
    return false;
  }
  return true;
}
...
var Binder = (_dec$5 = toxicDecorators.before(prettifyEventParameter), _dec2$4 = toxicDecorators.before(prettifyEventParameter), _dec3$3 = toxicDecorators.before(prettifyEventParameter), _dec4$3 = toxicDecorators.runnable(isEventEmitalbe), _dec5$2 = toxicDecorators.before(checkEventEmitParameter), _dec6$2 = toxicDecorators.runnable(isEventEmitalbe, {
  backup: function backup() {
    return false;
  }
}), _dec7$1 = toxicDecorators.before(checkEventEmitParameter), _dec8$1 = toxicDecorators.runnable(isEventEmitalbe), _dec9$1 = toxicDecorators.before(checkEventEmitParameter), _dec10$1 = toxicDecorators.runnable(isEventEmitalbe, {
  backup: function backup() {
    return false;
  }
}), _dec11$1 = toxicDecorators.before(checkEventEmitParameter), (_class$5 = function () {
  ...
  _createClass(Binder, [{
    ...
    value: function bindEventOnPenetrateNode(node) {
      ...
      this.bindedEventInfo['video-dom'].forEach(function (_ref10) {
        ...
        remove ? chimeeHelper.removeEvent(node, name, fn) : _this._addEventOnDom(node, name, fn);
      });
    }
    ...
    value: function bindEventOnVideo(node) {
      ...
      this.bindedEventInfo['video-dom'].concat(this.bindedEventInfo.video).forEach(function (_ref12) {
        ...
        remove ? chimeeHelper.removeEvent(node, name, fn) : _this2._addEventOnDom(node, name, fn);
      });
    }
      ...
      this.kinds.forEach(function (target) {
        if (target === 'kernel') {
          ...
          _this4.bindedEventInfo[target].forEach(function (_ref18) {
            ...
            chimeeHelper.removeEvent(targetDom, name, fn);

            if (target === 'video-dom') {
              _this4.__dispatcher.dom.videoExtendedNodes.forEach(function (node) {
                return chimeeHelper.removeEvent(node, name, fn);
              });
            }
          });
        }
    ...
    value: function _addEventOnDom(element, key, fn) {
      if (passiveEvents.indexOf(key) > -1) {
        return chimeeHelper.addEvent(element, key, fn, false, { passive: true });
      }
    ...
    value: function _removeEventListenerOnTargetWhenIsUseless(_ref21) {
      ...
      if (!chimeeHelper.isEmpty(this.buses[target].events[name])) return;
      ...
      if (target === 'kernel') {
        ...
        if (target === 'video-dom') {
          this.__dispatcher.dom.videoExtendedNodes.forEach(function (node) {
            ...
            chimeeHelper.removeEvent(node, name, fn);
          });
        }
      }
...
var Dispatcher = (_dec$6 = toxicDecorators.before(convertNameIntoId), _dec2$5 = toxicDecorators.before(checkPluginConfig), _dec3$4 = toxicDecorators.before(convertNameIntoId), _dec4$4 = toxicDecorators.before(convertNameIntoId), _dec5$3 = toxicDecorators.before(convertNameIntoId), (_class$6 = function () {
  ...
  _createClass(Dispatcher, [{
    ...
    value: function unuse(id) {
      ...
      if (!chimeeHelper.isObject(plugin) || !isFunction(plugin.$destroy)) {
        delete this.plugins[id];
        return;
      }
      plugin.$destroy();
        ...
        return function () {
          return new _Promise(function (resolve, reject) {
            ...
            _videoError = function videoError(evt) {
              ...
              var error = void 0;
              if (!chimeeHelper.isEmpty(evt.data) && evt.data.errmsg) {
                var errmsg = evt.data.errmsg;

                chimeeHelper.Log.error("chimee's silentload bump into a kernel error", errmsg);
    ...
    value: function installKernel(key, value) {
      ...
      tasks.forEach(function (_ref2) {
        ...
        if (isFunction(kernelsSet[key])) chimeeHelper.Log.warn('You have alrady install a kernel on ' + key + ', and now we will replace it');
...
var GlobalConfig = (_class$7 = function () {
  ...
  return GlobalConfig;
}(), (_descriptor$1 = _applyDecoratedDescriptor$6(_class$7.prototype, '_silent', [toxicDecorators.nonenumerable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
...
var Chimee = (_dec$7 = toxicDecorators.autobindClass(), _dec$7(_class$8 = (_class2$1 = (_temp = _class3 = function (_VideoWrapper) {
  ...
  _createClass(Chimee, null, [{
    ...
    value: function registerEvents() {
      ...
      if (!name || !chimeeHelper.isString(name)) throw new Error('The event name must be a string, but not ' + (typeof name === 'undefined' ? 'undefined' : _typeof(name)));
      if (!target || !chimeeHelper.isString(target)) throw new Error('The event target must be a string, but not ' + (typeof target === 'undefined' ? 'undefined' : _typeof(target)));
      if (target === 'kernel') {
  ...
  function Chimee(config) {
    ...
    if (chimeeHelper.isString(config) || isElement(config)) {
      config = {
        wrapper: config,
        controls: true
      };
...
}), _applyDecoratedDescriptor$7(_class2$1, 'plugin', [toxicDecorators.frozen], (_init = _Object$getOwnPropertyDescriptor(_class2$1, 'plugin'), _init = _init ? _init.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'config', [toxicDecorators.frozen], (_init2 = _Object$getOwnPropertyDescriptor(_class2$1, 'config'), _init2 = _init2 ? _init2.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'install', [toxicDecorators.frozen], (_init3 = _Object$getOwnPropertyDescriptor(_class2$1, 'install'), _init3 = _init3 ? _init3.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'uninstall', [toxicDecorators.frozen], (_init4 = _Object$getOwnPropertyDescriptor(_class2$1, 'uninstall'), _init4 = _init4 ? _init4.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'hasInstalled', [toxicDecorators.frozen], (_init5 = _Object$getOwnPropertyDescriptor(_class2$1, 'hasInstalled'), _init5 = _init5 ? _init5.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'installKernel', [toxicDecorators.frozen], (_init6 = _Object$getOwnPropertyDescriptor(_class2$1, 'installKernel'), _init6 = _init6 ? _init6.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'uninstallKernel', [toxicDecorators.frozen], (_init7 = _Object$getOwnPropertyDescriptor(_class2$1, 'uninstallKernel'), _init7 = _init7 ? _init7.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'hasInstalledKernel', [toxicDecorators.frozen], (_init8 = _Object$getOwnPropertyDescriptor(_class2$1, 'hasInstalledKernel'), _init8 = _init8 ? _init8.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
...
}), _class2$1), _applyDecoratedDescriptor$7(_class2$1, 'getPluginConfig', [toxicDecorators.frozen], (_init9 = _Object$getOwnPropertyDescriptor(_class2$1, 'getPluginConfig'), _init9 = _init9 ? _init9.value : undefined, {
  enumerable: true,
  configurable: true,
  writable: true,
  initializer: function initializer() {
