...
(function (global, factory) {
	...
	function isPrimitive(val) {
	  return isVoid(val) || isBoolean$1(val) || isString$1(val) || isNumber$1(val);
	}
	/**
	...
	function formatter(tag, msg) {
	  if (!isString$1(tag)) throw new TypeError('Log\'s method only acccept string as argument, but not ' + tag + ' in ' + (typeof tag === 'undefined' ? 'undefined' : _typeof(tag)));
	  if (!isString$1(msg)) return '[' + Log.GLOBAL_TAG + '] > ' + tag;
	...
	*/
	  ...
	  */
	  ...
	  _createClass(ChimeeKernel, [{
	    ...
	    value: function chooseBox(_ref) {
	      ...
	      if (isString_1(box) && box) return box;
	      src = src.toLowerCase();
	...
	function alias(other, key, option) {
	  ...
	  // argument validate
	  if (!isString$1(key)) throw new TypeError('@alias need a string as a key to find the porperty to set alias on');
	...
	function waituntil(key) {
	  ...
	  if (!isFunction$1(key) && !isPromise(key) && !isString$1(key)) throw new TypeError('@waitUntil only accept Function, Promise or String');
	  return function (obj, prop, descriptor) {
	...
	function watch() {
	  ...
	  if (!isString$1(operationPrefix)) throw new TypeError('operationPrefix must be an string');
	  return function (obj, prop, descriptor) {
	    var fns = args.reduce(function (fns, keyOrFn, index) {
	      if (!isString$1(keyOrFn) && !isFunction$1(keyOrFn)) {
	...
	function runnable(key) {
	  ...
	  if (!isFunction$1(key) && !isString$1(key)) throw new TypeError('@runnable only accept Function or String');
	  return function (obj, prop, descriptor) {
	    var _ref2 = descriptor || {},
	        _value = _ref2.value,
	        configurable = _ref2.configurable;
	...
	function string() {
	  ...
	  var defaultValue = isString$1(args[0]) ? args.shift() : '';
	...
	function eventBinderCheck(key, fn) {
	  if (!isString_1(key)) throw new TypeError('key parameter must be String');
	  ...
	  return accessor({
	    ...
	    set: function set(value) {
	      ...
	      if (value === undefined || isNumber_1(value)) {
	        val = value;
	      } else if (isString_1(value) && !_Number$isNaN(parseFloat(value))) {
	        val = value;
	      }
	...
	var VideoWrapper = (_dec$1 = autobindClass(), _dec2$1 = alias('silentLoad'), _dec3 = alias('fullScreen'), _dec4 = alias('$fullScreen'), _dec5 = alias('fullscreen'), _dec6 = alias('emit'), _dec7 = alias('emitSync'), _dec8 = alias('on'), _dec9 = alias('addEventListener'), _dec10 = before(eventBinderCheck), _dec11 = alias('off'), _dec12 = alias('removeEventListener'), _dec13 = before(eventBinderCheck), _dec14 = alias('once'), _dec15 = before(eventBinderCheck), _dec16 = alias('css'), _dec17 = before(attrAndStyleCheck), _dec18 = alias('attr'), _dec19 = before(attrAndStyleCheck), _dec$1(_class$1 = (_class2 = function () {
	  ...
	  _createClass(VideoWrapper, [{
	    ...
	    value: function $watch(key, handler) {
	      ...
	      if (!isString_1(key) && !isArray_1(key)) throw new TypeError('$watch only accept string and Array<string> as key to find the target to spy on, but not ' + key + ', whose type is ' + (typeof key === 'undefined' ? 'undefined' : _typeof(key)));
	      var watching = true;
	    ...
	    value: function $emit(key) {
	      ...
	      var target = void 0;
	      if (isObject$1(key) && isString_1(key.name) && isString_1(key.target)) {
	        target = key.target;
	        key = key.name;
	      }
	      if (!isString_1(key)) throw new TypeError('emit key parameter must be String');
	      /* istanbul ignore else  */
	    ...
	    value: function $emitSync(key) {
	      ...
	      if (!isString_1(key)) throw new TypeError('emitSync key parameter must be String');
	...
	function native(target, name) {
	  ...
	  if (!isString$1(name)) throw new Error('You must pass in a string as name, but not ' + (typeof name === 'undefined' ? 'undefined' : _typeof(name)) + '.');
	...
	function attrOperationCheck(target, attr, val) {
	  if (!isString_1(attr)) throw new TypeError('to handle dom\'s attribute or style, your attr parameter must be string, but not ' + attr + ' in ' + (typeof attr === 'undefined' ? 'undefined' : _typeof(attr)));
	  if (!isString_1(target)) throw new TypeError('to handle dom\'s attribute or style, your target parameter must be string, , but not ' + target + ' in ' + (typeof target === 'undefined' ? 'undefined' : _typeof(target)));
	...
	var Dom = (_dec$4 = waituntil('__dispatcher.videoConfigReady'), _dec2$3 = before(attrOperationCheck, targetCheck), _dec3$2 = before(attrOperationCheck, targetCheck), _dec4$2 = before(attrOperationCheck, targetCheck), _dec5$2 = before(attrOperationCheck, targetCheck), _dec6$1 = before(targetCheck), (_class$4 = function () {
	  ...
	  function Dom(config, dispatcher) {
	    ...
	    if (!isElement_1(wrapper) && !isString_1(wrapper)) throw new TypeError('Wrapper can only be string or HTMLElement, but not ' + (typeof wrapper === 'undefined' ? 'undefined' : _typeof(wrapper)));
	    var $wrapper = $(wrapper);
	  ...
	  _createClass(Dom, [{
	    ...
	    value: function insertPlugin(id, el) {
	      ...
	      if (!isString_1(id)) throw new TypeError('insertPlugin id parameter must be string');
	...
	function isEventEmitalbe(_ref2) {
	  ...
	  if (!name || !isString_1(name) || secondaryReg$1.test(name)) {
	...
	function convertNameIntoId(name) {
	  if (!isString_1(name)) throw new Error('Plugin\'s name must be a string, but not "' + name + '" in ' + (typeof name === 'undefined' ? 'undefined' : _typeof(name)));
	...
	function checkPluginConfig(config) {
	  ...
	  if (!isString_1(name) || name.length < 1) throw new TypeError('plugin must have a legal namea, but not "' + name + '" in ' + (typeof name === 'undefined' ? 'undefined' : _typeof(name)));
	}
	/**
	 * <pre>
	...
	var Dispatcher = (_dec$7 = before(convertNameIntoId), _dec2$6 = before(checkPluginConfig), _dec3$5 = before(convertNameIntoId), _dec4$5 = before(convertNameIntoId), _dec5$4 = before(convertNameIntoId), (_class$7 = function () {
	  ...
	  _createClass(Dispatcher, [{
	    ...
	    value: function use(option) {
	      if (isString_1(option)) option = { name: option, alias: undefined };
	      if (!isObject$1(option) || isObject$1(option) && !isString_1(option.name)) {
	        throw new TypeError('pluginConfig do not match requirement');
	      }
	      if (!isString_1(option.alias)) option.alias = undefined;
	      var _option = option,
	          name = _option.name,
	    ...
	    value: function load(srcOrOption) {
	      ...
	      var src = isString_1(srcOrOption) ? srcOrOption : isObject$1(srcOrOption) && isString_1(srcOrOption.src) ? srcOrOption.src
	    ...
	    value: function switchKernel(_ref) {
	      ...
	      var originVideoConfig = cloneDeep_1(this.videoConfig);
	...
	var Chimee = (_dec$8 = autobindClass(), _dec$8(_class$9 = (_class2$2 = (_temp = _class3 = function (_VideoWrapper) {
	  ...
	  _createClass(Chimee, null, [{
	    ...
	    value: function registerEvents() {
	      ...
	      if (!name || !isString_1(name)) throw new Error('The event name must be a string, but not ' + (typeof name === 'undefined' ? 'undefined' : _typeof(name)));
	      if (!target || !isString_1(target)) throw new Error('The event target must be a string, but not ' + (typeof target === 'undefined' ? 'undefined' : _typeof(target)));
	      if (target === 'kernel') {
	  ...
	  function Chimee(config) {
	    ...
	    if (isString_1(config) || isElement_1(config)) {
	      config = {
	        wrapper: config,
	        controls: true
	      };
	  ...
	  _createClass(Chimee, [{
	    ...
	    value: function __throwError(error) {
	      if (isString_1(error)) error = new Error(error);
