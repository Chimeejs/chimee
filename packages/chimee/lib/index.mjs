...
var nonenumerable = nonenumerable$2;
...
var accessorMap = {
  ...
  defaultMuted: [alwaysBoolean(), accessorVideoAttribute({
    get: 'defaultMuted',
    set: 'muted',
    isBoolean: true
  })],
...
__decorate$1([initString(function (str) {
  ...
  _createClass(Dom, [{
    ...
    value: function setPluginsZIndex(plugins) {
      ...
      plugins.forEach(function (key, index) {
        return style(key.match(/^(videoElement|container)$/) ? _this2[key] : _this2.plugins[key], 'z-index', ++index);
      });
    }
  }, {
    key: "setStyle",
    ...
    value: function $watch(key, handler) {
      ...
      var watcher = function watcher() {
        if (watching && (!(this instanceof VideoConfig) || this.dispatcher.changeWatchable)) {
          bind(handler, this).apply(void 0, arguments);
        }
      };
      ...
      applyDecorators(target, _defineProperty({}, property, watch(watcher, {
        deep: deep,
        diff: diff,
        proxy: proxy
      })), {
...
__decorate$5([nonenumerable$2], VideoWrapper.prototype, "$container", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "$pluginOrder", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "$plugins", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "$video", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "$wrapper", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "inPictureInPictureMode", null);

__decorate$5([nonenumerable$2], VideoWrapper.prototype, "pictureInPictureWindow", null);
    ...
    if (!isEmpty(methods) && _isPlainObject(methods)) {
      Object.keys(methods).forEach(function (key) {
        ...
        Object.defineProperty(_assertThisInitialized(_this), key, {
          configurable: true,
          enumerable: false,
          value: bind(fn, _assertThisInitialized(_this)),
          writable: true
        });
      });
    }
...
__decorate$6([nonenumerable$2], Dispatcher.prototype, "inPictureInPictureMode", null);
