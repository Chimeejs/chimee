...
(function (global, factory) {
	  ...
	  createClass(Dom, [{
	    ...
	    value: function setPluginsZIndex(plugins) {
	      ...
	      plugins.forEach(function (key, index$$1) {
	        return domHelpers_1(key.match(/^(videoElement|container)$/) ? _this2[key] : _this2.plugins[key], 'z-index', ++index$$1);
	      });
	    }
	  }, {
	    key: "setStyle",
	...
	var EventEmitter$1 = /*#__PURE__*/Object.freeze({
		default: events$1,
		__moduleExports: events$1,
		EventEmitter: events_1$1
	});
	  ...
	  function ChimeePlugin(_ref, dispatcher) {
	    ...
	    if (!isEmpty(methods) && isPlainObject_1(methods)) {
	      Object.keys(methods).forEach(function (key) {
	        ...
	        Object.defineProperty(assertThisInitialized(assertThisInitialized(_this)), key, {
	          configurable: true,
	          enumerable: false,
	          value: bind$1(fn, assertThisInitialized(assertThisInitialized(_this))),
	          writable: true
	        });
	      });
	    }
	    ...
	    if (!isEmpty(data) && isPlainObject_1(data)) {
	      Object.assign(assertThisInitialized(assertThisInitialized(_this)), cloneDeep_1(data));
	    }
	    ...
	    if (!isEmpty(computed) && isPlainObject_1(computed)) {
	      ...
	      applyDecorators(assertThisInitialized(assertThisInitialized(_this)), props, {
	        self: true
	      });
	    }
	    ...
	    applyDecorators(assertThisInitialized(assertThisInitialized(_this)), {
	      $inner: frozen,
	      $penetrate: frozen
	    }, {
	      self: true
	...
	function (_ChimeePlugin) {
	  ...
	  function PictureInPicture(config, dispatcher, option) {
	    ...
	    _this.requestPictureInPicture = function () {
	      ...
	      window.__chimee_picture_in_picture = {
	        element: _this.$video,
	        plugin: assertThisInitialized(assertThisInitialized(_this)),
	        window: _this.$dom
	      };
	      return Promise.resolve();
	    };
	...
	function (_VideoWrapper) {
	  ...
	  function Chimee(rawConfig) {
	    ...
	    _this.dispatcher = new Dispatcher(config, assertThisInitialized(assertThisInitialized(_this)));
