...
(function (global, factory) {
	...
	(global.ChimeePluginMobileState = factory(global.Chimee,global.ChimeePluginGesture));
...
var MobileState$1 = function (_super) {
  ...
  function MobileState(config, dispatcher, option) {
    ...
    var _a = option || {},
        _b = _a.expectTime,
        expectTime = _b === void 0 ? 3e4 : _b,
        _c = _a.errorTips,
        errorTips = _c === void 0 ? '加载失败，请刷新重试' : _c,
        _d = _a.icon,
        icon = _d === void 0 ? {} : _d;
  ...
  MobileState.prototype.onDoubletap = function (evt) {
    var playElements = query_10(this.$dom, 'chimee-state-play');

    if (playElements && playElements[0] && query_7(playElements[0], evt.target)) {
      this.play();
    }
  };
