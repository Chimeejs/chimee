...
var chimeeCenterState = gestureFactory({
  name: 'chimeeCenterState',
  el: '\n    <chimee-state>\n      <chimee-state-loading></chimee-state-loading>\n      <chimee-state-play>\n      </chimee-state-play>\n      <chimee-state-volume>\n        <chimee-state-volume-icon>\n          \n          <svg viewBox="0 0 107 101" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n            <g>\n              <polygon points="0.407316446 30 27.6500779 30 57.3737293 2.84217094e-14 58.4762532 100 27.6500779 70 0.407316446 70"></polygon>\n              <path d="M71,73 L92,89" stroke-width="8" stroke-linecap="round"></path>\n              <path d="M76.4032258,53.6071429 L100.596774,43.3928571" stroke-width="8" stroke-linecap="round" transform="translate(88.500000, 48.500000) rotate(23.000000) translate(-88.500000, -48.500000) "></path>\n              <path d="M72,26 L93,10" stroke-width="8" stroke-linecap="round"></path>\n            </g>\n          </svg>\n        </chimee-state-volume-icon>\n        <chimee-state-volume-bar>\n          <chimee-state-volume-bar-track></chimee-state-volume-bar-track>\n          <chimee-state-volume-bar-value></chimee-state-volume-bar-value>\n        </chimee-state-volume-bar>\n      </chimee-state-volume>\n      <chimee-state-light>\n        <chimee-state-light-icon>\n          <svg viewBox="0 0 775 775" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n            <g>\n              <circle id="Oval" stroke-width="30" cx="370" cy="406" r="144"></circle>\n              <path d="M291.320312,678 L454.679688,678" id="Line" stroke-width="24" stroke-linecap="round"></path>\n              <path d="M307.255859,750 L437.744141,750" id="Line" stroke-width="24" stroke-linecap="round"></path>\n              <path d="M0.255859375,358 L130.744141,358" id="Line" stroke-width="24" stroke-linecap="round"></path>\n              <path d="M620.255859,358 L750.744141,358" id="Line" stroke-width="24" stroke-linecap="round"></path>\n              <path d="M89.2558594,156 L219.744141,156" id="Line" stroke-width="24" stroke-linecap="round" transform="translate(154.500000, 156.000000) rotate(44.000000) translate(-154.500000, -156.000000) "></path>\n              <path d="M569.365426,204.134574 L661.634574,111.865426" id="Line" stroke-width="40" stroke-linecap="round"></path>\n              <path d="M324.365426,112.134574 L416.634574,19.8654257" id="Line" stroke-width="40" stroke-linecap="round" transform="translate(370.500000, 66.000000) rotate(-45.000000) translate(-370.500000, -66.000000) "></path>\n            </g>\n          </svg>\n        </chimee-state-light-icon>\n        <chimee-state-light-bar>\n          <chimee-state-light-bar-track></chimee-state-light-bar-track>\n          <chimee-state-light-bar-value></chimee-state-light-bar-value>\n        </chimee-state-light-bar>\n      </chimee-state-light>\n      <chimee-state-error>\u52A0\u8F7D\u5931\u8D25\uFF0C\u8BF7\u5237\u65B0\u91CD\u8BD5</chimee-state-error>\n    </chimee-state>\n  ',
  create: function create() {
    this.volumeBar = this.$dom.querySelector('chimee-state-volume-bar-value');
    this.lightBar = this.$dom.querySelector('chimee-state-light-bar-value');
  },
  ...
  events: {
    ...
    volumechange: function volumechange() {
      ...
      chimeeHelper.setStyle(this.volumeBar, 'height', height);
    },

    // 屏幕亮度
    lightchange: function lightchange() {
      var height = this.light * 100 + '%';
      chimeeHelper.setStyle(this.lightBar, 'height', height);
    },
